...
var clock;$(function(){$("#my-menu").mmenu({extensions:["widescreen","theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo2.png" alt="Rkon - разработка landing page">'},offCanvas:{position:"right"}}),$("#my-menu").data("mmenu").bind("opened",function(){$(".hamburger").addClass("is-active")}).bind("closed",function(){$(".hamburger").removeClass("is-active")})}),$(".callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(".callback2").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success2").addClass("visible").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success2").removeClass("visible").fadeOut(),e.trigger("reset"),$.magnificPopup.close()},3e3)}),!1}),$(".popup-with-move-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom"}),$(".reviews").owlCarousel({loop:!0,items:1,autoplay:!0,smartSpeed:700}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top_button").addClass("active"):$(".top_button").removeClass("active")}),$(".top_button").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")}),clock=$(".your-clock").FlipClock({clockFace:"DailyCounter",autoStart:!1,language:"ru-ru"});var dt="July 20 2018 15:44:00",first=new Date(dt),last=Date.now(),remaining=first-last;remaining/=1e3,clock.setTime(172800),clock.setCountdown(!0),clock.start(),$(".top_nav a").mPageScroll2id();